...
create_accounts() {
  ./pcloud-cli.sh account_create_db_dual $SAFE_NAME $ACCOUNT_PLATFORM_ID $ACCOUNT_NAME1 testuser1 Cyberark1 192.168.68.122 petclinic 3306 MySQL-DA 1 Active
  ./pcloud-cli.sh account_create_db_dual $SAFE_NAME $ACCOUNT_PLATFORM_ID $ACCOUNT_NAME2 testuser2 Cyberark1 192.168.68.122 petclinic 3306 MySQL-DA 2 Inactive
}
