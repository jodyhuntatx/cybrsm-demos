...
# Identity Flows tenant variables
export FLOWS_TENANT_ID=acj5413
export FLOWS_URL=https://$FLOWS_TENANT_ID.id.integration-cyberark.cloud
export FLOWS_DOMAIN=idflows.com
...
export PUB_KEYS="$($CURL --request POST			\
