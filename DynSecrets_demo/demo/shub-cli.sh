...
showUsage() {
  ...
  echo "    $0 filters_get <store-id>"
  echo "    $0 filter_get <store-id> <filter-id>"
  echo "    $0 filters_create <store-id> NOT IMPLEMENTED YET"
  echo "    $0 filter_delete <store-id> <filter-id> NOT IMPLEMENTED YET"
  echo
