...
# use url-encoded hostname in URL when NOT using token-app-property
...
export REST_ENDPOINT=https://$CONJUR_LEADER_HOSTNAME/authn-jwt/$JWT_SERVICE_ID/$CONJUR_ACCOUNT/authenticate
