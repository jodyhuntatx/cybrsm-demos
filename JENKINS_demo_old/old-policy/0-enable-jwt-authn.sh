...
export JWKS_URI=http://conjur-master-minikube:8086/jwtauth/conjur-jwk-set

export PROJECT_NAME=jenkins
export TOKEN_APP_PROPERTY=jenkins_full_name	# claim containing name of host identity
export IDENTITY_PATH=$PROJECT_NAME	# Conjur policy path to host identity definition

export JWT_ISSUER=http://conjur-master-minikube:8086
