...
if [[ "$CLIENT_ID" != "" ]]; then
    imds_endpoint="http://169.254.169.254/metadata/identity/oauth2/token?api-version=2018-02-01&client_id=${CLIENT_ID}&resource=https%3A%2F%2Fmanagement.azure.com%2F"
  else
